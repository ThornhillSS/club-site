                ...
                <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                    <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                        ...
                        <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                            ...
                            <a href="https://tssoj.ca/discord" className={'font-medium text-primary hover:text-secondary'} target='_blank' rel='noreferrer'>
                                Get Started
                            </a>
                        </div>
                    </nav>
                ...
                <Transition as={Fragment} enter="duration-150 ease-out" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="duration-100 ease-in" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                    <Popover.Panel focus className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                        <div className={'rounded-lg shadow-md bg-background ring-1 ring-black ring-opacity-5 overflow-hidden'}>
                            ...
                            <a href={callToAction.href} className={'block w-full px-5 py-3 text-center font-medium text-primary bg-gray-50 hover:bg-gray-100'}>
                                {callToAction.text}
                            </a>
                        </div>
                    </Popover.Panel>
